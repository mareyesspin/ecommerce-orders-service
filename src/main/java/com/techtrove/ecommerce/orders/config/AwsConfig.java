...
import com.techtrove.ecommerce.orders.models.config.AwsCredentials;
...
public class AwsConfig {
    ...
    public AwsCredentials awsCredentials() {
        return AwsCredentials.create(ordersProperties.awsRegion);
    }
    @Autowired
    ...
    public AmazonSQS amazonSQS(){
        return AmazonSQSClientBuilder.standard()
                .withRegion(ordersProperties.awsRegion)
    ...
    public SimpleMessageListenerContainer simpleMessageListenerContainer(AmazonSQSAsync amazonSQSAsync,
        ...
        simpleMessageListenerContainer.setMaxNumberOfMessages(ordersProperties.sqsMaxMessages);
    ...
    public ThreadPoolTaskExecutor threadPoolTaskExecutor() {
        ...
        executor.setCorePoolSize(ordersProperties.sqsMaxMessages);
